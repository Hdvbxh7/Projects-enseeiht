...
public class ExempleComprendre {
	...
	public static void main(String[] args) {
		...
		p1.translater(6, -2);
		afficher("p1", p1);		// Qu'est ce qui est affiché ?  p1=(9,-4)

		// Changer l'abscisse de p1 et afficher p1
		System.out.println("> p1.setX(0);");
		p1.setX(0);
		afficher("p1", p1);		// Qu'est ce qui est affiché ? p1=(0,-4)
		...
		Point p3 = p1;
		afficher("p3", p3);		// Qu'est ce qui est affiché ? p3=(O,-4)
		afficher("p1", p1);		// Qu'est ce qui est affiché ? p1=(0,-4)

		// Déplacer p3
		System.out.println("> p3.translater(100, 100);");
		p3.translater(100, 100);
		afficher("p3", p3);		// Qu'est ce qui est affiché ? p3=(100,96)

		// Afficher p1
		afficher("p1", p1);		// Qu'est ce qui est affiché ? p1=(100,96)
