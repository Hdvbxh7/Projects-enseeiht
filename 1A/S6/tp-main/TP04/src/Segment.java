...
public class Segment {
	...
	*/
	...
	public void dessiner(Ecran e1){
		e1.dessinerLigne(this.extremite1.getX(),this.extremite1.getY(),this.extremite2.getX(),this.extremite2.getY(), this.couleur);
	}
	
	public void dessinerSVG(AfficheurSVG e1){
		e1.dessinerLigne(this.extremite1.getX(),this.extremite1.getY(),this.extremite2.getX(),this.extremite2.getY(), this.couleur);
	}
