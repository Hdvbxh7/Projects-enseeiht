...
Axiom snoc_Nil : forall (e : A),
  snoc_spec e Nil=Cons e Nil .
...
Theorem snoc_alternative : forall (e : A) (l : liste),
...
Theorem snoc_append : forall (e : A) (l1 l2 : liste),
...
Fixpoint snoc_impl (e : A) (l : liste) {struct l} : liste := 
  match l with
     Nil => Cons e Nil
     | Cons t1 q1 => Cons t1  (snoc_impl e q1)
end.
